...
namespace Asyncoroutine
{
    public static class AwaiterCoroutineExtension
    {
        ...
        public static AwaiterCoroutine<WaitForSecondsRealtime> GetAwaiter(
            this WaitForSecondsRealtime waitForSecondsRealtime)
        {
        ...
        public static AwaiterCoroutine<CustomYieldInstruction> GetAwaiter(
