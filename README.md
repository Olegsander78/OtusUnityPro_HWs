...
Научиться реализовывать системные компоненты игры
...
Научиться применять паттерн MVP-Presentation Model для реализации окон пользовательского интерфейса
...
Реализовать систему загрузки/сохранения массива апгрейдов c помощью Mediating-Controller
...
Научиться реализовывать игровые механизмы
...
Научиться реализовывать обертку и состояния для аниматора в Unity
...
Научиться реализовывать механики взаимодействия персонажа с миром
...
Научиться реализовывать систему прокачки и апгрейды
...
Научиться реализовывать интерфейс при помощи паттерна MVP-Passive
...
Научиться реализовывать мета-механики
...
Научиться реализовывать синхронизацию игры по реальному времени
...
Научиться реализовывать новый функционал на базе имеющегося, соблюдая принцип Open-Closed Principle
...
Научиться реализовывать Unit тесты
